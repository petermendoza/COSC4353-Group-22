        ...
        <div class = "wrapper-large">
            ...
            <p>All fields marked with * are required</p>
                ...
                <div className = "input-box-large">
                        <input type = "text" placeholder = 'Full Name*' required minLength = "1" maxLength = "50" onChange = {
                ...
                <div className = "input-box-large">
                        <input type = "text" placeholder = 'Address 1*' required minLength = "1" maxLength = "100" onChange = { 
                ...
                <div className = "input-box-large">
                        <input type = "text" placeholder = 'Address 2 (optional)' required minLength = "0" maxLength = "100" onChange = { 
                ...
                <div className = "input-box-small">
                        <input type = "text" placeholder = 'City*' required minLength = "1" maxLength = "100" onChange = { 
                            e => {setCharCountCity(e.target.value.length); setCity(e.target.value)}
                        }/>
                        
                        <input type="text" placeholder = 'Zipcode*' required minLength = "1" maxLength = "9" onChange = { 
                        ...
                        <div class="inline">
                            <p class = "charLimit" id="cityCharLimit">{charLimitCity - charCountCity} characters remaining.</p>
                        </div>
                        <div class="inline">
                            <p class="charLimit" id="zipcodeCharLimit">{charLimitZipcode - charCountZipcode} characters remaining.</p>
                        </div>                                            
                </div>
                <Link to = "/Profile">
